...
Yes. Cloud Run (fully managed) can run [gRPC](https://grpc.io/) services with [server-streaming RPCs](https://grpc.io/docs/guides/concepts/#server-streaming-rpc) and send partial responses in a single request. Cloud Run also supports [unary (non-streaming) RPCs](https://grpc.io/docs/guides/concepts/#unary-rpc). 
